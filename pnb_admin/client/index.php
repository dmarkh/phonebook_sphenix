...
<body>
  ...
  <div class="ui-layout-west">
	<div class="ui-layout-content ui-widget-content">
		...
		<ul>
			...
			<li onClick="client.confirm_mass_emailr()" style="cursor: pointer; margin-top: 10px;"><img src="images/icons/excel.png" border=0 style="vertical-align: middle;"> Mass Email: IB Members</li>
		</ul>
		<ul>
			<li onClick="client.get_authorlist_xml()" style="cursor: pointer"><img src="images/icons/list.png" border=0 style="vertical-align: middle;"> Author List: XML</li>
		...
		<ul style="list-style-type: none;">
			<li><a target="_blank" href="https://www.sphenix.bnl.gov/" style="text-decoration: none;"><img src="images/icons/link-star.png" style="vertical-align: middle;"> sPHENIX WWW</a></li>
		</ul>
	</div>
  </div>
  ...
  <div class="ui-layout-north">
	<div style="position: absolute; top: 10px; right: 10px; color: #FFF !important;" id="close_all_tabs">[close all tabs]</div>
	<div style="position: absolute; top: 10px; left: 10px; color: #FFF !important;" ><a href="https://www.sphenix.bnl.gov/pnb/" style="color: #FFF; text-decoration: none;">[ to PUBLIC version ]</a></div>
    ...
    <h3 class="ui-widget-header" style="font-weight: normal; font-size: 24px; color: #FFFF50; font-family: 'Oswald', verdana;">
		<span style="color: #FFF;">PhoneBook:</span> <a href="https://www.sphenix.bnl.gov/" style="text-decoration: none;"><span style="text-shadow: 1px 1px #CCC; color: #ECE0D8;">sPHENIX Collaboration</style></a>
 ...
 <div class="ui-layout-center">
        <div id="tabs">
        	...
        	<div id="tabs-1">
				<h2 style="color: #F33; text-shadow: 1px 1px #FFF; font-size: 1.5em;">NOTE: this is an Administrative Interface for sPHENIX Collaboration's PhoneBook</h2>
				...
				<p>sPHENIX Collabration's PhoneBook allows one to find out information about sPHENIX institutions and members of each institution, as well as statistical information on the sPHENIX Collaboration.
