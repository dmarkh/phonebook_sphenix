...
RCLIENT.Phonebook = function () {
	...
	this.tabCounter = 4;
        ...
        this.service_url = 'https://www.sphenix.bnl.gov/pnb/service/index.php';
...
RCLIENT.Phonebook.prototype = {
    ...
    display_worldmap: function() {
        ...
        $('body').append('<div id="worldmapdialog" title="sPHENIX Collaboration, Institution Locations over the World"><div id="worldmap" style="height: 100%; width: 100%"></div></div>');
	...
	display_institution_details: function(id) {
		...
		content += '<p style="padding: 5px;">Institution representative(s) on sPHENIX Institutional Board: ';
		var reps = [];
		...
		if ( exofficioreps.length > 0 ) {
			content += '<p style="padding: 5px;">Ex-officio representative(s) on sPHENIX Institutional Board: ';
	...
	console.log( 'inst_id: ' + inst_id );
	    ...
	    if ( !institutions_list[i] ) { console.log( institutions_list, i ); }
            ...
            if (mem_addr1 != undefined && mem_addr1 != '' && mem_city != undefined && mem_city != '' && mem_postcode != undefined && mem_postcode != '') {
              ...
              if (inst_city != undefined && inst_city != '') {
                content += inst_city + '<br>';
              }
              if (inst_state != undefined && inst_state != '' && inst_zip != undefined && inst_zip != '') {
                content += ', ' + inst_state +' ' + inst_zip + '<br>';
              }
              if (inst_country != undefined && inst_country != '') {
                content += inst_country + ' <br>';
// + '<img src="images/flags_iso_3166/16/'+inst_country_code.toLowerCase()+'.png" style="vertical-align: middle;"> '+ '<br>';
              }
		content += '<br>';
            }
	...
	display_member_details_old: function(id) {
		var service = this;
		var fields = service.members[id]['fields'];
		var label = 'Member: '+fields[1]+' '+fields[3];
		tabid = service.addTab(label);
